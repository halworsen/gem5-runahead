...
class NLLBInterimPeriods(Plotter):
    name = 'Instructions retired by interim periods between runahead (NLLB model)'
    fname = 'nllb/nllb_interim_periods'
    ...
    def load_data(self) -> None:
        ...
        for bench in self.benchmarks():
            self.data[bench] = self.read_stats(bench, 'm5out-spec2017-re-nllb')
