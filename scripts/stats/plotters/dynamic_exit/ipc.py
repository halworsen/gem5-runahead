...
class DynamicExitIPC(Plotter):
    name = 'Dynamic exit model IPC'
    fname = 'dynexit/ipc'
    description = 'Dynamic exit model IPCs'
    ...
    def construct_frames(self) -> None:
        ...
        all_insts = {'O3': 0, 'Runahead': 0, 'Minimum Work': 0, 'Dynamic Exit': 0}
        all_cycles = {'O3': 0, 'Runahead': 0, 'Minimum Work': 0, 'Dynamic Exit': 0}
        for bench in self.benchmarks():
            for model in ['O3', 'Runahead', 'Minimum Work', 'Dynamic Exit']:
        ...
        all_ipc = {
            ...
            'Dynamic Exit': all_insts['Dynamic Exit'] / all_cycles['Dynamic Exit'],
        }
        ...
        print(frame[(frame['variant'] == 'Dynamic Exit') | (frame['variant'] == 'Runahead')])
        self.frame = frame
